...
const ProductDetail = () => {
  ...
  // Mock Thumbnails (using main image only as requested)
  const thumbnails = [
    product.image
  ];
  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        title: product.name,
        text: `Check out this beautiful ${product.name} at A One Nursery!`,
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '40px' }}>
          ...
          <div style={{ flex: '1 1 50%', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '15px', marginBottom: '25px', paddingBottom: '25px', borderBottom: '1px solid #eee' }}>
              ...
              <span style={{ padding: '4px 12px', background: '#e8f5e9', color: 'var(--secondary)', borderRadius: '20px', fontSize: '12px', fontWeight: 700 }}>
                {product.stock}
              </span>
            </div>
            ...
            <p style={{ color: '#555', fontSize: '15px', lineHeight: '1.8', marginBottom: '30px' }}>
              The {product.name} is a stunning addition to any space, perfectly curated by A One Nursery. Known for its air-purifying qualities and lush foliage, it thrives with minimal care. Delivered fresh, healthy, and securely potted.
            </p>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '50px', marginBottom: '40px' }}>
            ...
            <div style={{ flex: '1 1 500px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
              ...
              <p style={{ color: '#666', lineHeight: 1.6 }}>
                Every plant from A One Nursery is hand-picked, thoroughly inspected, and securely packed. Over {product.reviewCount} customers have trusted us to bring greenery into their lives. Read what they have to say below!
              </p>
            </div>
          </div>
        </div>
