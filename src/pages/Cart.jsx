...
const Cart = () => {
  ...
  const handlePlaceOrder = () => {
    ...
    const whatsappUrl = `https://wa.me/919588705078?text=${encodedText}`;
      ...
      <div className="container" style={{ maxWidth: '1100px' }}>
        ...
        <div className="checkout-layout">
          ...
          <div className="checkout-content">
            <div className="checkout-main-panel" style={{ background: 'white', padding: '30px', borderRadius: '20px', boxShadow: '0 4px 15px rgba(0,0,0,0.02)' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                      <div style={{ display: 'flex', gap: '15px' }}>
                        ...
                        <div style={{ flex: 1 }}>
                          ...
                          <input type="tel" value={formData.phone} onChange={(e) => setFormData({ ...formData, phone: e.target.value })} placeholder="Your phone no" style={{ width: '100%', padding: '12px 15px', borderRadius: '10px', border: '1px solid #ddd', fontSize: '14px', outline: 'none' }} />
                        </div>
                      </div>
          ...
          <div className="checkout-sidebar-right">
            <div className="checkout-summary-panel" style={{ background: 'white', padding: '25px', borderRadius: '20px', boxShadow: '0 4px 15px rgba(0,0,0,0.02)', position: 'sticky', top: '100px' }}>
