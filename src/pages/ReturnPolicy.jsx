      ...
      <div className="container">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '30px', maxWidth: '800px', margin: '0 auto' }}>
          ...
          >
            ...
            <p style={{ color: 'var(--text-dark)', lineHeight: '1.8' }}>
              To initiate a return or replacement, please email us at <strong>nursery@aonenursery.com</strong> or send us a WhatsApp message at <strong>+91 9588705078</strong> with your order number and photos of the item.
            </p>
          </motion.div>
