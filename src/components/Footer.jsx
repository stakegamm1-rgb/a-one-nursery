...
import { FaLeaf, FaPhoneAlt, FaEnvelope, FaFacebook, FaInstagram, FaTwitter, FaWhatsapp } from 'react-icons/fa';
    ...
    <footer style={{ background: 'var(--dark-green)', color: 'var(--text-light)', padding: '60px 0 20px' }}>
      <div className="container">
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '40px', marginBottom: '40px' }}>
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '20px' }}>
              ...
              <span style={{ fontSize: '24px', fontWeight: 800 }}>A One Nursery</span>
            </div>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
              <ul style={{ listStyle: 'none', padding: 0, opacity: 0.8, lineHeight: '2' }}>
                ...
                <li><FaWhatsapp color="#25D366" style={{ marginRight: '8px', verticalAlign: 'middle' }} size={16} /> +91 9588705078</li>
                <li>✉️ nursery@aonenursery.com</li>
              </ul>
            </div>
          </div>
        ...
        <div style={{ textAlign: 'center', marginTop: '40px', paddingTop: '20px', borderTop: '1px solid rgba(255,255,255,0.1)', opacity: 0.6 }}>
          <p>© 2026 A One Nursery. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
