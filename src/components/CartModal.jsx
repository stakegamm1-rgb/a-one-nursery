            ...
            {step === 2 && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                <div>
                  ...
                  <input type="tel" className="input-field" value={formData.phone} onChange={(e) => setFormData({...formData, phone: e.target.value})} placeholder="Your phone no" style={{ width: '100%', padding: '12px', borderRadius: '10px', border: '1px solid #ccc' }} />
                </div>
