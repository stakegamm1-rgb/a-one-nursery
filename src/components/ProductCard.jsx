    ...
    >
      <Link to={`/product/${product.id}`} style={{ textDecoration: 'none', color: 'inherit', display: 'flex', flexDirection: 'column', flex: 1 }}>
            ...
            {isHovered && (
              ...
              >
                ...
                <button 
                  ...
                  className="btn" 
                  style={{ display: 'flex', alignItems: 'center', gap: '5px', padding: '8px 12px', fontSize: '13px', background: 'var(--primary)', border: 'none' }}
                >
                  <FaBolt /> Buy
                </button>
              </motion.div>
        ...
        <div style={{ padding: '15px', display: 'flex', flexDirection: 'column', flex: 1 }}>
          ...
          <h3 style={{ fontSize: '16px', color: 'var(--dark-green)', marginBottom: '4px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{product.name}</h3>
          
          <p style={{ fontSize: '12px', color: '#666', marginBottom: '8px', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden' }}>
            {product.description}
          </p>
